<%-- 
    Document   : updateyard
    Created on : Jun 25, 2022, 5:10:31 PM
    Author     : phuth
--%>
...
<html>
    ...
    <body>
        ...
        <div id="body">
            ...
            <div class="main">
                <h2>Sửa sân lớn</h2>
                <form action="MainServlet" class="user_manager" method="POST" enctype="multipart/form-data">
                    <table class="add_yard_manager">
                        ...
                        <tr>
                            <td>ID Sân</td>
                            <td><input type="text" class="name" name="yardId" value=${sessionScope.YARD_INFO.yardID} readonly=""></td>
                        </tr>

                        <tr>
                            <td>Username chủ Sân</td>
                            <td><input type="text" class="name" name="yardOwnerId" value=${sessionScope.YARD_INFO.userID} readonly=""></td>
                        </tr>
                        <tr>
                            <td>Tên Sân</td>
                    ...
                    <<input type="button" value="Update" name="BTACTION"/>
                </form>
            </div>
        </div>
    </body>
